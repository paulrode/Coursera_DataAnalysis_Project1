---
title: "Coursera_DataAnalysis_Project1"
...
if (!getwd() == "C:/Users/paulr/Documents/R/Coursera_ExploratoryDataAnalysis/ExData_Plotting1") {setwd("C:/Users/paulr/Documents/R/Coursera_ExploratoryDataAnalysis/ExData_Plotting1")}
...
household <- read.csv("./data/household_power_consumption.txt", sep = ";", header = TRUE, na.strings = "?")
...
household1 <- filter(household, Date == "2007-02-01" & Date == "2007-02-02")
hist(household1$Global_active_power, xlab = "Global Active Power (kilowatts)", ylab = "Frequency", main = "Global Active Power", col = "red")



with(household1, plot(Date, Global_active_power))
view(household1$Date)
